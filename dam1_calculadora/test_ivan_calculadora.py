...
from dam1_calculadora.ivan_calculadora_alumnos import es_resultado_negativo, multiplicar, dividir, potencia
...
def test_es_resultado_negativo(num1, num2):

    assert es_resultado_negativo(7, -8) == -1
