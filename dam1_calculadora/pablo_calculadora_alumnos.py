...
def sumar(numero1: float, numero2: float):
    ...
    ARGS:
        numero1 (float): Primer número de la suma
        numero2 (float): Segundo número de la suma
    
    RETURNS:
        (float): La suma de los dos números introducidos
    """
...
def restar(numero1: float, numero2: float):
    ...
    ARGS:
        numero1 (float): Primer número de la resta
        numero2 (float): Segundo número de la resta
    
    RETURNS:
        (float): La resta de los dos números introducidos
    """
...
def es_resultado_negativo(num1: float, num2: float) -> bool:
    ...
    RETURNS:
        True si el resultado de una operación entre ellos es negativo y false si no lo es
...
def multiplicar(num1:float, num2:float) -> float:
    ...
    #Este if comprueba si solo uno de los 2 números es negativo para al final del programa escribirlo
    if es_resultado_negativo(num1, num2):
        negativo = True

    #Este if comprueba si el primer número es negativo para transformarlo a positivo
    if num1 < 0:
        num1 = restar(0, num1)
    
    #Este if comprueba si el segundo número es negatibo para transformarlo a positivo
    if num2 < 0:
        num2 = restar(0, num2)

    for i in range(1, num2):
        num1 = sumar(num1, num1)
...
def potencia(num1: float, num2: float):
    """
    Realiza la potencia del número num1
    
    ARGS:
        num1 (float): Es el número al que hay que hacerle la potencia
        num2 (float): La potencia del número
    
    RETURNS:
        (float): El número num1 elevado a la potencia num2    
    ...
    if num2 == 0:
        ...
        for i in range(num2):
            resultado = sumar(resultado, multiplicar(num1, num1))
