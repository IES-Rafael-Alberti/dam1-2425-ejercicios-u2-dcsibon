...
def sumar(num1: float, num2: float) -> int:
    # TODO: Realizar el desarrollo completo, incluida la documentación... recibe 2 números float y retorna la suma de ambos.
    """
    Suma los 2 número recibidos y retorna la suma de ambos. 
    
    Args:
        num1 (float): Primer número recibido en la función.
        num2 (float): Segundo número recibido en la función.

    Returns:
        int: Resultado de la suma de los 2 valores introducidos.
    """
    suma = round(num1) + round(num2)

    return suma



def restar(num1: float, num2: float) -> int:
    # TODO: Realizar el desarrollo completo, incluida la documentación... recibe 2 números float y retorna la resta de ambos.
    """
    Resta los 2 número recibidos y retorna la resta de ambos. 
    ...
    Returns:
        int: Resultado de la resta de los 2 valores introducidos.
    """
    resta = round(num1) - round(num2)
...
def es_resultado_negativo(num1: float, num2: float) -> bool:
    ...
    Args:
        num1 (float): Primer número recibido en la función para ser comprobado.
        num2 (float): Segundo número recibido en la función para ser comprobado.

    Returns:
        bool: Es 'True' si alguno de los números recibidos es negativo y 'False' en caso contrario. 
...
def multiplicar(num1: float, num2: float) -> int:
    ...
    #Llamada a es_resultado_negativo() para comprobar si existen negativos y actualizar num1, num2
    negativo, num1, num2 = es_resultado_negativo(num1, num2)
    multiplicacion = 0

    #Bucle for que suma uno de los numeros tantas veces como el valor del otro numero.
    #Existen 2 bucles debido a que se compara previamente que numero es menor para evitar la recurrencia de operaciones.
    #Ejemplo: No es lo mismo  '2 * 5 = 2 + 2 + 2 + 2 + 2 = 10' que '5 * 2 = 5 + 5 = 10'
    if num2 < num1:
        for i in range (0, round(num2)):
            multiplicacion += round(num1)
    else:
        for i in range (0, round(num1)):
            multiplicacion += round(num2)
...
def main():
    ...
    while not desea_salir:
        ...
        if entrada == "":
            entrada_salir = pedir_entrada("¿Desea salir de la calculadora? (s/n) ")
            if entrada_salir == "s":
                desea_salir = True
            elif entrada_salir != "n":
                mostrar_error(4)
        elif entrada == "lista":
