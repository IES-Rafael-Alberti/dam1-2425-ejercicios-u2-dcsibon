...
def limpiar_pantalla():
    ...
    try:
        ...
        raise ValueError(f"Problemas al intentar limpiar la pantalla {error}")
...
def sumar(num1:float, num2:float):
    ...
    Returns:
        suma de los dos números en float
    """
...
def restar(num1:float, num2:float):
    """
    Recibe dos números en float y los resta
    ...
    Returns:
        resta de los dos números en float
    """
...
def es_resultado_negativo() -> bool:
...
def calcular_operacion(num1: float, num2: float, operador: str,entrada: str,resultado) -> float:
    """
    ...
    elif entrada == "potencia":
        potencia(num1, operador, num2)
...
def obtener_operaciones() -> str:
    ...
    tecla_enter = input("Presione ENTER para continuar...")
...
def main():
    ...
    while not desea_salir:
        ...
        if entrada == "":
            ...
            num = decimales
            num =int(num)
            if entrada == f"decimales {num}":
                resultado = f"{0:.{decimales}f}"
