...
def sumar(num1: float, num2: float) -> float:
    """Hace la suma entre num1 y num 2
    ...
    Returns:
        resultado (float): Resultado de la suma.
    """
...
def calcular_operacion(num1: float, num2: float, operador: str) -> float:
    ...
    try:
        ...
        mostrar_error(f"Entrada no válidad{e}")
...
def realizar_calculo(decimales,resultado_almacenado,num1,num2):
    """
    ...
    while realizando_calculos:
        ...
        if entrada == "cancelar":
            ...
            return resultado, f"Cálculo cancelado, resultado no modificado (RES => {resultado:.{decimales}f})."
            ...
            operador = calcular_operacion(num1, num2, operador)
...
def main():
    ...
    while not desea_salir:
        ...
        print (f"El resultado almacenado por defecto es: {resultado}")
        ...
        entrada = pedir_entrada(f"Operación (RES => {resultado}) >> ").lower().strip()
        ...
        if entrada == "":
            ...
            realizar_calculo(decimales, resultado,num1, num2)
