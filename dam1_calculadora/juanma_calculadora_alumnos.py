...
def es_resultado_negativo(num1: float, num2: float, resultado: int) -> bool:
    ...
    # Si uno de los números es negativo, el resultado lo será también, pero si lo son ambos, el resultado será positivo.
    if num1 == f"- {num1}" or num2 == f"- {num2}":
        resultado == f"- {resultado}"
    elif num1 == f"- {num1}" and num2 == f"- {num2}":
        resultado == f"{resultado}"
    elif num1 == f"{num1}" and num2 == f"{num2}":
        resultado == f"{resultado}"    
    return resultado
...
def dividir(num1, num2):
    ...
    try:
        ...
        input("La operación introducida es una indeterminación, introduce otra: ")
...
def pedir_entrada(entrada: str) -> str:
    """
    ...
    entrada = "Introduce una entrada: ".strip().lower()
...
def obtener_operaciones() -> str:
    ...
    """
    operador = input("Introduce el tipo de operación que quiere realizar: ")

    try: 
        if operador == OPERADORES: 
            return True
    except ValueError:
        input("Operación inválida, introduzca una de nuevo: ")
...
def main():
    ...
    suma = print(sumar(num1, num2))
    resta = print(restar(num1, num2))
