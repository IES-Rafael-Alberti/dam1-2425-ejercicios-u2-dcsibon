...
from daw1b_calculadora.fran_calculadora_alumnos import es_resultado_negativo, multiplicar, dividir, potencia
...
def test_es_negativo():
    # El resultado es negativo
    assert es_resultado_negativo(-3, 3) == True
    assert es_resultado_negativo(7, -2) == True

    # El resultado no es negativo
    assert es_resultado_negativo(-7, -4) == False
    assert es_resultado_negativo(5, 2) == False
