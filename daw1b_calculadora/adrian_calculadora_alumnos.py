...
def limpiar_pantalla():
    ...
    try:
        ...
        raise("Problemas al intentar limpiar la pantalla {error}")
...
def sumar(num1, num2):
    """Realiza las suma de los 2 numeros proporcionados

    Args:
        num1 (float): 1º Numero real introducido por el usuario
        num2 (float): 2º Numero real introducido por el usuario

    Returns:
        float: La suma de ambos numeros
    """
...
def restar(num1, num2):
    """Realiza la resta de los 2 numeros proporcionados
    ...
    Returns:
        float: La resta de ambos numeros
    """
...
def multiplicar(num1:str, num2:str):
    """
    ...
    num1 = str(num1)
    num2 = str(num2)
    signo = es_resultado_negativo(float(num1), float(num2))
    num1 = num1.replace("-", "")
    num2 = num2.replace("-", "")
    num1 = float(num1)
    num1 = int(num1)
    ...
    if num1 == 0 or num2 == 0:
        ...
        if num1 > num2:
            ...
            for i in range(0, num1-1,+1):
                resultado = resultado+int(num2)
    if signo == True:
        s = "-"
        resultado = s+str(resultado)
...
def dividir(num1, num2):
    ...
    if num1 == 0 or num2 == 0:
        ...
        resultado = num1
        # Esto va restando el resultado hasta que es menor que 0 por lo cual implica que ya no se puede continuar dividiendo y tienes el resultado
        while resultado >= 0:
            resultado -= num2
            if resultado >= 0:
                contador += 1
...
def potencia(num1, num2):
    """Esto realiza la potencia dada por el usuario usando la funcion de multiplicar
    ...
    Returns:
        float: Te devuelve el resultado de la potencia
    """
