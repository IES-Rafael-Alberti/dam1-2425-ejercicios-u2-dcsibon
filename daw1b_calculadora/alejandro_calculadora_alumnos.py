...
def potencia(num1 :float, num2 :float) -> int:
    """
    Realiza la potencia de dos números usando la funcion multiplicar que utiliza sumas.
...
def main():
    ...
    while not desea_salir:
        ...
        if entrada == "":      
                desea_salir = pedir_entrada("¿Desea salir de la calculadora? (s/n) ")         
                if desea_salir == "s":
                    desea_salir = True
                    limpiar_pantalla()
                    print("\n\n\n\n Chao Pescaoooooo \n\n\n\n")
                    ...
                    print("Entrada invalida, tiene que ser **s** o **n**")
...
# formatear el primer numero que sale despues de res=> para que salga con los decimales que tienen que salir que esten configurados