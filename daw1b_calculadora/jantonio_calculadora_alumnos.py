...
def limpiar_pantalla():
    ...
    try:
        ...
        return f"*ERROR {e}* Fallo al limpiar consola."
...
def sumar(num1: float, num2:float)-> int:
    ...
    """
    Devuelve el resultado de la suma entre 2 numeros.

    Args:
        num1 (float): numero 1 a la suma entre 2 numeros.
        num2 (float): numero 2 a la suma entre 2 numeros.
    """
    suma = num1 + num2
    return round(suma)
...
def restar(num1: float, num2:float)-> int:
    ...
    """
    Devuelve el resultado de la resta entre 2 numeros.

    Args:
        num1 (float): numero 1 a la resta entre 2 numeros.
        num2 (float): numero 2 a la resta entre 2 numeros.
    """
    resta = num1 - num2
    return round(resta)
...
def calcular_operacion(numero: float, operador: str, resultado: float) -> float:
    """
...
def realizar_calculo(decimales: int, resultado_almacenado: int):
    """
    ...
    while realizando_calculos:
        ...
        if entrada == "cancelar":
            ...
            operador = OPERADORES.index(entrada)
...
def main():
    ...
    while not desea_salir:
        ...
        if entrada == "":
            ...
            limpiar_pantalla()
            print(realizar_calculo(decimales, resultado))
