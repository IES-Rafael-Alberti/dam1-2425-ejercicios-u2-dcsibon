...
def sumar(num1: float, num2: float)-> float:
    """
    Funcion que suma dos parametros de tipo decimal.

    Args:
        num1 (float): Nº primero a sumar.
        num2 (float): Nº segundo a sumar.
...
def restar(num1: float, num2: float)-> float:
    """
    Funcion que resta dos parametros de tipo decimal.

    Args:
        num1 (float): Nº primero al que restar.
        num2 (float): Nº segundo que restará al primero.
    Return:
        float.
    """
...
def es_resultado_negativo(num1: float, num2: float) -> bool:
    ...
    Args:
        num1 (float): nº primero para determinar si es negativo o no
        num2 (float): nº segundo para retornar si es negativo o no

    return:
        bool: devuelve true en caso de que sea negativo y false si no lo es.
    """
...
def potencia(base: int, exponente: int)-> int:
    """
    Funcion que eleva un nuemro a su exponente seleccionado.

    Args:
        base (int): nº que va a ser elevado.
        exponente (int): potencia a la que se elevará el nº base.

    Return:
        int: devuelve un resultado entero.
...
def calcular_operacion(num1: float, num2: float, operador: str) -> float:
    ...
    if operador in OPERADORES[0]:
        resultado = sumar(num1, num2)
    elif operador in OPERADORES[1]:
        resultado = restar(num1, num2)
    elif operador in OPERADORES[2] + OPERADORES[3]:
        resultado = multiplicar(num1, num2)
    elif operador in OPERADORES[4] + OPERADORES[5]:
        resultado = dividir(num1, num2)
    elif operador in OPERADORES[6] + OPERADORES[7]:
        resultado = potencia()
