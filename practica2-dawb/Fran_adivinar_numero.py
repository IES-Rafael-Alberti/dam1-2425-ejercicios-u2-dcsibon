...
def adivina_el_numero(numero_oculto: int, total_intentos: int, minimo: int, maximo: int, frio: int, caliente: int):
    ...
    while not numero_adivinado and intentos_realizados != total_intentos:
        ...
        if numero_usuario == numero_oculto:
            ...
            if evaluar_diferencia(numero_usuario, numero_oculto, frio, caliente) == 0:
                if numero_oculto < numero_usuario:
                    print(f"\nFRÍO, FRÍO, el numero oculto es MENOR... ¡te quedan {total_intentos - intentos_realizados} intentos.\n")
                    time.sleep(1)
                else:
                    print(f"\nFRÍO, FRÍO, el numero oculto es MAYOR... ¡te quedan {total_intentos - intentos_realizados} intentos.\n")
                    time.sleep(1)
            elif evaluar_diferencia(numero_usuario, numero_oculto, frio, caliente) == 1:
                if numero_oculto < numero_usuario:
                    print(f"\nCALIENTE, CALIENTE, el numero oculto es MENOR... ¡te quedan {total_intentos - intentos_realizados} intentos.\n")
                    time.sleep(1)
                else:
                    print(f"\nCALIENTE, CALIENTE, el numero oculto es MAYOR... ¡te quedan {total_intentos - intentos_realizados} intentos.\n")
                    time.sleep(1)
            elif evaluar_diferencia(numero_usuario, numero_oculto, frio, caliente) == 2:
                if numero_oculto < numero_usuario:
                    print(f"\n¡TE QUEMAS!, el numero oculto es MENOR... ¡te quedan {total_intentos - intentos_realizados} intentos.\n")
                    time.sleep(1)
                else:
                    print(f"\n¡TE QUEMAS! el numero oculto es MAYOR... ¡te quedan {total_intentos - intentos_realizados} intentos.\n")
                    time.sleep(1)
...
def configurar_juego() -> tuple:
    ...
    minimo, maximo = input("Maximo: ")
    frio, caliente = input("Minimo: ")
...
def elegir_opcion_menu() -> int:
    ...
    while not opcion_correcta:
        ...
        if not opcion_correcta:
            print(f"Opción {opcion} incorrecta! (1-4)")
...
def genera_numero_oculto(minimo, maximo):
    ...
    """
    Genera un número oculto denntro del rango minimo-maximo
...
def main():
    ...
    intentos = 5
    salir = False
    mostrar_configuracion(minimo, maximo, frio, caliente, intentos)
