...
def pedir_numero_usuario(mensaje: str, minimo: int = None, maximo: int = None) -> int:
    num = print(int("Introduce un numero")str:)
    ...
    while True: 
        try:
            ...
            if adivinanza < numero_oculto:
                print("Frio. El numero mayor")
            elif adivinanza > numero_oculto:
                print("Caliente. El numero mayor")
            else:
                print(f"¡¡Felicidades!! Has encontrado el numero oculto en {intentos}.\n ")
            break
        except ValueError:
