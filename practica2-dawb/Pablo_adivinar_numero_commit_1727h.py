...
def configurar_intentos(rango_numero_oculto) -> int:
    ...
    rango_numero_oculto = configurar_rangos_numeros()
    ...
    while not valor_correcto:
        try:
            intentos = pedir_numero_usuario("Introduce las pistas para el valor frio > ")
...
def elegir_opcion_menu() -> int:
    ...
    while not opcion_correcta:
        ...
        if opcion is not opcion_correcta:
...
def genera_numero_oculto(minimo, maximo):
    ...
    rango = configurar_rangos_numeros()
