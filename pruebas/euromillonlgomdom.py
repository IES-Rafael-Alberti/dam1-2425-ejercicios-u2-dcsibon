...
def mostrar_resultados(numeros_premiados:set,estrellas_premiadas:set,numeros:set,estrellas:set,aciertos_numeros:int,aciertos_estrellas:int):
    """
...
def main():
    ...
    while not salir:
        ...
        entrada=input("Deseas jugar otra? S/N >>  ")
        if entrada.upper()=="S":
            salir= False
        else:
            salir= True
